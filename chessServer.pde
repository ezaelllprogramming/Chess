...
void mouseReleased() {
  if(counter == 0) {
    ...
    if (!(row2 == row1 && col2 == col1)) {
      ...
      grid[row1][col1] = ' ';
      counter = 1;
      myServer.write(row1 + "," + col1 + "," + row2 + "," + col2 + "," + counter + "," + piece);
      firstClick = true;
    }
   }
  }
...
void keyPressed() {
  ...
  if (key == 'q' || key == 'Q') {
    ...
    for (int c = 0; c < 8; c++) {
      if (grid[0][c] == 'p') {
        grid[0][c] = ' ';
        myServer.write(row1 + "," + col1 + "," + row2 + "," + c + "," + counter + "," + 1);
        grid[0][c] = 'q';      
      }
    }
  }
  ...
  if (key == 'r' || key == 'R') {
    ...
    for (int c = 0; c < 8; c++) {
      if (grid[0][c] == 'p') {
        grid[0][c] = ' ';
        myServer.write(row1 + "," + col1 + "," + row2 + "," + c + "," + counter + "," + 2);
        grid[0][c] = 'r';      
      }
    }
  }
  ...
  if (key == 'b' || key == 'B') {
    ...
    for (int c = 0; c < 8; c++) {
      if (grid[0][c] == 'p') {
        grid[0][c] = ' ';
        myServer.write(row1 + "," + col1 + "," + row2 + "," + c + "," + counter + "," + 3);
        grid[0][c] = 'b';      
      }
    }
  }
  ...
  if (key == 'k' || key == 'K') {
    ...
    for (int c = 0; c < 8; c++) {
      if (grid[0][c] == 'p') {
        grid[0][c] = ' ';
        myServer.write(row1 + "," + col1 + "," + row2 + "," + c + "," + counter + "," + 4);
        grid[0][c] = 'k';      
      }
    }
  }
  ...
  if (key == 'q' || key == 'Q') {
    ...
    for (int c = 0; c < 8; c++) {
      if (grid[7][c] == 'P') {
        grid[7][c] = ' ';
        myServer.write(row1 + "," + col1 + "," + row2 + "," + c + "," + counter + "," + 5);
        grid[7][c] = 'Q';      
      }
    }
  }
  ...
  if (key == 'r' || key == 'R') {
    ...
    for (int c = 0; c < 8; c++) {
      if (grid[7][c] == 'P') {
        grid[7][c] = ' ';
        myServer.write(row1 + "," + col1 + "," + row2 + "," + c + "," + counter + "," + 6);
        grid[7][c] = 'R';      
      }
    }
  }
  ...
  if (key == 'b' || key == 'B') {
    ...
    for (int c = 0; c < 8; c++) {
      if (grid[7][c] == 'P') {
        grid[7][c] = ' ';
        myServer.write(row1 + "," + col1 + "," + row2 + "," + c + "," + counter + "," + 7);
        grid[7][c] = 'B';      
      }
    }
  }
  ...
  if (key == 'k' || key == 'K') {
    ...
    for (int c = 0; c < 8; c++) {
      if (grid[7][c] == 'P') {
        grid[7][c] = ' ';
        myServer.write(row1 + "," + col1 + "," + row2 + "," + c + "," + counter + "," + 8);
        grid[7][c] = 'K';      
      }
    }
  }
